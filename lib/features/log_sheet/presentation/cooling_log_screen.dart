  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return LogListView<CoolingRecord>(
      ...
      columns: [
        ...
        LogColumn('Initial Temp', (r) => CoolingRecord.tempLabel(r.initialTempF), numeric: true),
        LogColumn('Stage 1 Time', (r) => r.stage1Time.labelOrDash),
        LogColumn('Stage 1 Temp', (r) => CoolingRecord.tempLabel(r.stage1TempF), numeric: true),
        LogColumn('Stage 2 Time', (r) => r.stage2Time.labelOrDash),
        LogColumn('Stage 2 Temp', (r) => CoolingRecord.tempLabel(r.stage2TempF), numeric: true),
