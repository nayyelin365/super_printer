      ...
      child: Column(
        children: [
          ...
          _NavIcon(
            ...
            selected: selected == AppSection.sushiRice,
            onTap: () => onSelect(AppSection.sushiRice),
            tooltip: 'Sushi Rice Preparation',
          ),
          const SizedBox(height: 8),
          _NavIcon(
          ...
          _NavIcon(
            ...
            selected: selected == AppSection.alarms,
            onTap: () => onSelect(AppSection.alarms),
            tooltip: 'Alarms',
          ),
          const SizedBox(height: 8),
          _NavIcon(
